  ...
  return (
    <div className='i' id="intro">
        <div className='i-left'>
            ...
            <p className="i-desc">
            I enjoy designing and developing applications across various technologies. I love traveling the world, meeting new people, and exploring different cultures. Cooking is a passion of mine, and I cherish spending quality time with friends and family.  </p>
            <div className="links">
            <a href="/Resume.pdf" type="application/pdf" download="Resume.pdf">
  Download Resume
</a>
