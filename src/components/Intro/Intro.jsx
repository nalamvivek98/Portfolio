  ...
  return (
    <div className='i'>
        <div className='i-left'>
            ...
            <p className="i-desc">
                I design and develop pages for the website,specializing in creating stylish,modern websites,web services online stores. 
            </p>
            </div>
            <svg width="75" height="75px" viewBox="0 0 25 25" fill="none" stroke='black' className='i-scroll' xmlns="http://www.w3.org/2000/svg">
